...
//chuyển biến kiêu string sang int
...
bool LoadMediaAndTtf()
{
    ...
    gFontText = TTF_OpenFont( "font//ARCADE.ttf", 55);
...
int main (int argc, char* argv[] )
{
    if( LoadMediaAndTtf())
    {
        ...
        while( Play_Game)
        {
            ...
            SDL_Rect ene4 = { 0, GROUND, 100, 100};
            while (!Quit)
            {
